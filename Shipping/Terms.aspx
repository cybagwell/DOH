<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Terms.aspx.vb" Inherits="DOHPricing.Terms" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:SqlDataSource ID="srcSqlDataSourceTerm" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" InsertCommand="INSERT INTO t_TermsOfPayment(Term) VALUES (@Term)" SelectCommand="SELECT Id, Term FROM t_TermsOfPayment" UpdateCommand="UPDATE t_TermsOfPayment SET Term = @Term WHERE (Id = @id)">
        <InsertParameters>
